...
#define RESTAR_H 
	...
	Polinomio *restar_polinomios(Polinomio *p1, Polinomio *p2);
	Polinomio *restar_polinomios_of(Polinomio *, Polinomio *);
...
Polinomio *restar_polinomios_of(Polinomio *p1, Polinomio *p2)
{
	Polinomio *q;
	Polinomio *resta = NULL;

	for(q = p1; q != NULL; q = q->liga)
		resta = insertar_in(resta, q->coef, q->grado);

	for(q = p2; q != NULL; q = q->liga)
		resta = insertar_in(resta, q->coef * (-1), q->grado);

	resta = reduce_polinomio(resta);
