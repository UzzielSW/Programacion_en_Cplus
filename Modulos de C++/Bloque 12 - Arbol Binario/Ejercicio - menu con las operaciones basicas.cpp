...
enum { PreOrden=1, InOrden, PostOrden};
...
int main()
{
	...
	do{ system("cls");
		...
		switch(opc){
			case 1:
				cout<<"\n ingrese un dato [0 para salir]: "; cin>>dato;
				while (dato != 0){
					InsertarNodo(Arbol, dato);
					cout<<" ingrese un dato [0 para salir]: "; cin>>dato;
				}
			break;
			...
			case 3:
				if(Arbol != NULL){
					cout<<"\n ingrese el dato que desea buscar: "; cin>>dato;
